# Equinfra
#jmeter -Jthreads=200 -Jloops=5 --nongui --reportatendofloadtests --testfile jmx_files/equinfra.jmx --logfile log.txt --reportoutputfolder users200_loops5
...
# Overall
jmeter -Jthreads=200 -Jloops=1 -Jip=127.0.0.1 -Jport=8080 -Jpath=geoserver --nongui --logfile log.txt --testfile jmx_files/equinfra.jmx --reportatendofloadtests --reportoutputfolder results
rm log.txt jmeter.log
