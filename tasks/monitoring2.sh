...
do
	...
	cut -d ":" -f 103 ./statistics/stats.txt 1> ./statistics/precpu_total_usage.txt
	cut -d "," -f 1 ./statistics/precpu_total_usage.txt 1> ./statistics/precpu_total_usage2.txt

	cut -d ":" -f 107 ./statistics/stats.txt 1> ./statistics/presystem_cpu_usage.txt
	cut -d "," -f 1 ./statistics/presystem_cpu_usage.txt 1> ./statistics/presystem_cpu_usage2.txt

	cut -d ":" -f 108 ./statistics/stats.txt 1> ./statistics/preonline_cpus.txt
	...
	cut -d ":" -f 103 ./statistics/stats2.txt 1> ./statistics/cpu_total_usage.txt
	cut -d "," -f 1 ./statistics/cpu_total_usage.txt 1> ./statistics/cpu_total_usage2.txt

	cut -d ":" -f 107 ./statistics/stats2.txt 1> ./statistics/system_cpu_usage.txt
	cut -d "," -f 1 ./statistics/system_cpu_usage.txt 1> ./statistics/system_cpu_usage2.txt

	cut -d ":" -f 108 ./statistics/stats2.txt 1> ./statistics/online_cpus.txt
